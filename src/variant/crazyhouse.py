...
# Use bughouse/crazyhouse piece values rather than those for normal chess.
piece_material = {
    '-': 0,
    'p': 1,
    'n': 2,
...
class Crazyhouse(BaseVariant):
    ...
    def get_b1(self, passed=None):
        """ Print <b1> holding info. """
        # Printing b1 lines seems unnecessary for zh, but current FICS
        # does it and some clients seem to depend on it.
